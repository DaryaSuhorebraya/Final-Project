            ...
            <div class="review-block">
                <c:if test="${requestScope.reviews != null}">
                    <c:forEach var="review" items="${requestScope.reviews}">
                        ...
                        <div class="col-sm-9">
                            <h3 ><a class="movie-title" href="Controller?command=view-movie&movieId=${review.idMovie}">${review.movieTitle}</a></h3>
                            <div class="review-block-rate">
                                <input class="input-stars"  data-size="xs" value="${review.rating}" data-min="0" data-max="10" data-step="1" class="rating rating-loading">
                            </div>
